...
/**********************************************************************************************************
 ...
 @Return				void
**********************************************************************************************************/
void NET_APP_ONENET_PollExecution(ONENET_ClientsTypeDef* pClient)
{	
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Check Ok");
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Check Fail ECde %d", NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Check Fail");
	#endif
#endif
		return;
	}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
			GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Set Ok");
#endif
		}
		else {
			/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		#if NBIOT_PRINT_ERROR_CODE_TYPE
			GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Set Fail ECde %d", NBStatus);
		#else
			GPRS_DEBUG(DEBUG_INFO, "NB FullFunc Set Fail");
		#endif
#endif
			return;
		}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Check Ok");
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Check Fail ECde %d", NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Check Fail");
	#endif
#endif
		return;
	}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
			GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Set Ok");
#endif
		}
		else {
			/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		#if NBIOT_PRINT_ERROR_CODE_TYPE
			GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Set Fail ECde %d", NBStatus);
		#else
			GPRS_DEBUG(DEBUG_INFO, "NB MinFunc Set Fail");
		#endif
#endif
			return;
		}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB BAND Read %d Ok", pClient->LWM2MStack->NBIotStack->Parameter.band);
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB BAND Read Fail ECde %d", NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB BAND Read Fail");
	#endif
#endif
	}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
			GPRS_DEBUG(DEBUG_INFO, "NB BAND Set %d Ok", ONENET_NBIOT_BAND_TYPE);
#endif
		}
		else {
			/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		#if NBIOT_PRINT_ERROR_CODE_TYPE
			GPRS_DEBUG(DEBUG_INFO, "NB BAND Set %d Fail ECde %d", ONENET_NBIOT_BAND_TYPE, NBStatus);
		#else
			GPRS_DEBUG(DEBUG_INFO, "NB BAND Set %d Fail", ONENET_NBIOT_BAND_TYPE);
		#endif
#endif
			return;
		}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB CGATT %d Ok", pClient->LWM2MStack->NBIotStack->Parameter.netstate);
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB CGATT %d Fail ECde %d", pClient->LWM2MStack->NBIotStack->Parameter.netstate, NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB CGATT %d Fail", pClient->LWM2MStack->NBIotStack->Parameter.netstate);
	#endif
#endif
		return;
	}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB Set CGATT %d Ok", Attach);
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB Set CGATT %d Fail ECde %d", Attach, NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB Set CGATT %d Fail", Attach);
	#endif
#endif
	}
}
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
		GPRS_DEBUG(DEBUG_INFO, "NB Parameter Check Ok");
#endif
	}
	else {
		/* Dictate execute is Fail */
...
#ifdef ONENET_DEBUG_LOG_RF_PRINT
	#if NBIOT_PRINT_ERROR_CODE_TYPE
		GPRS_DEBUG(DEBUG_INFO, "NB Parameter Check Fail ECde %d", NBStatus);
	#else
		GPRS_DEBUG(DEBUG_INFO, "NB Parameter Check Fail");
	#endif
#endif
		return;
	}
